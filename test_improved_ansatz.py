...
ansatz.compose(improved_conv_layer(8, "c1", "improved"), list(range(8)), inplace=True)

# First Pooling Layer
ansatz.compose(improved_pool_layer([0,1,2,3], [4,5,6,7], "p1", "improved"), list(range(8)), inplace=True)

# Second Convolutional Layer
ansatz.compose(improved_conv_layer(4, "c2", "improved"), list(range(4, 8)), inplace=True)

# Second Pooling Layer
ansatz.compose(improved_pool_layer([0, 1], [2, 3], "p2", "improved"), list(range(4, 8)), inplace=True)

# Third Convolutional Layer
ansatz.compose(improved_conv_layer(2, "c3", "improved"), list(range(6, 8)), inplace=True)
