"""
Qiskit example QNN running 100 times with 8 qbits 200iter SPSA optimizer
"""
...
for run in range(num_runs):
    ...
    classifier = NeuralNetworkClassifier(
        qnn,
        optimizer=SPSA(maxiter=200),  # Using SPSA optimizer instead of COBYLA
...
filename = f'qcnn_8qubit_spsa_100_runs_results_{int(time.time())}.csv'
...
plt.tight_layout()
plot_filename = f'qcnn_8qubit_spsa_100_runs_plot_{int(time.time())}.png'
