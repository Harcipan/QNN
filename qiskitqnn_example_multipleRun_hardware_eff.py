"""
Qiskit example  QNN running 100 times with 8 qbits 200iter COBYLA optimizer
"""
...
filename = f'qcnn_8qubit_100_runs_results_{int(time.time())}.csv'
...
plt.tight_layout()
plot_filename = f'qcnn_8qubit_100_runs_plot_hardware_eff_{int(time.time())}.png'
